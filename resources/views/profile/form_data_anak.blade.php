...
<html>
  ...
  <body class="m-0 font-sans text-base antialiased font-normal leading-default bg-gray-50 text-slate-500">
    ...
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
        ...
        <div class="items-center block w-auto max-h-screen  h-sidenav grow basis-full">
            <ul class="flex flex-col pl-0 mb-0">
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 shadow-soft-xl text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg bg-white px-4 font-semibold text-slate-700 transition-colors" href="{{ route('data_anak') }}">
    ...
    <main class="ease-soft-in-out xl:ml-68.5 relative h-full max-h-screen rounded-xl transition-all duration-200">
        ...
        <nav>
            <h6 class="mb-0 font-bold capitalize">Data Anak</h6>
        </nav>
      ...
      <div class="w-full px-6 py-6 mx-auto">
        ...
        <div class="max-w-md mx-auto bg-white shadow-lg rounded-lg p-6 space-y-4">
            ...
            <form class="space-y-4">
                <div class="space-y-2">
                    <input type="text" class="flex h-10 w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm" placeholder="Nama Anak" />
                </div>
    
                <!-- Dropdown untuk Jenis Kelamin -->
                <div class="space-y-2">
                    <select class="flex h-10 w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm">
                ...
                <div class="space-y-2">
                    <input type="text" class="flex h-10 w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm" placeholder="Usia" />
                </div>
    
                <div class="space-y-2">
                    <input type="text" class="flex h-10 w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm" placeholder="Berat Saat Ini" />
                </div>
    
                <div class="space-y-2">
                    <input type="text" class="flex h-10 w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm" placeholder="Tinggi Saat Ini" />
                </div>
    
                <div class="space-y-2">
                    <textarea class="flex min-h-[80px] w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm" placeholder="Keluhan"></textarea>
                </div>
    
                <div class="space-y-2">
                    <textarea class="flex min-h-[80px] w-full rounded-md border border-gray-300 bg-gray-50 px-3 py-2 text-sm" placeholder="Pertanyaan Untuk Dokter"></textarea>
                </div>

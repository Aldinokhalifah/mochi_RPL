            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-start mb-3">
                    <div class="bg-light p-3 rounded text-dark shadow-sm" style="max-width: 70%;">
                        <p class="mb-0">Hallo, Selamat Pagi Ibu. Sesi Chat Akan Otomatis Dimulai Pada Jam Jadwal Konsultasi</p>
                    </div>
                </div>
                <!-- Message from user -->
                <div class="d-flex align-items-end justify-content-end mb-3">
                    <div class="bg-primary text-white p-3 rounded shadow-sm" style="max-width: 70%;">
                        <p class="mb-0">Hallo Dok, Selamat Pagi</p>
                    </div>
                </div>
                <!-- Another doctor message -->
                <div class="d-flex align-items-start mb-3">
                    <div class="bg-light p-3 rounded text-dark shadow-sm" style="max-width: 70%;">
                        <p class="mb-0">Untuk lebih lanjutnya tolong isi perkembangan anak ya bu</p>
                    </div>
                </div>
                <!-- Another user message -->
                <div class="d-flex align-items-end justify-content-end mb-3">
                    <div class="bg-primary text-white p-3 rounded shadow-sm" style="max-width: 70%;">
                        <p class="mb-0">baik Dok</p>
                    </div>
                </div>
            </div>
        </div>

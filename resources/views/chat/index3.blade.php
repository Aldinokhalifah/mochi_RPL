            ...
            <div class="d-flex flex-column">
                ...
                <div class="d-flex align-items-start mb-3">
                    <div class="bg-light p-3 rounded text-dark shadow-sm" style="max-width: 70%;">
                        <p class="mb-0">HAllo Ibu, untuk resep obat nya sudah saya kirimkan ya ibu</p>
                    </div>
                </div>
                <!-- Message from user -->
                <div class="d-flex align-items-end justify-content-end mb-3">
                    <div class="bg-primary text-white p-3 rounded shadow-sm" style="max-width: 70%;">
                        <p class="mb-0">Hallo Dok, baik dok terimakasih</p>
                    </div>
                </div>
                <!-- Another doctor message -->
                <div class="d-flex align-items-start mb-3">
                    <div class="bg-light p-3 rounded text-dark shadow-sm" style="max-width: 70%;">
                        <p class="mb-0">Jika ada perkembangan yang mungkin tidak baik, tolong konfirmasi saya ya bu</p>
                    </div>
                </div>
                <!-- Another user message -->
                <div class="d-flex align-items-end justify-content-end mb-3">
                    <div class="bg-primary text-white p-3 rounded shadow-sm" style="max-width: 70%;">
                        <p class="mb-0">Baik Dok, akan saya lakukan</p>
                    </div>
                </div>
            </div>
        </div>
